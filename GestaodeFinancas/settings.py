"""
Django settings for GestaodeFinancas project.
...
SECRET_KEY = 'django-insecure-a9d)wjs7&%5*7pq2h4vgp=4ph1*gv*c8ehgp2s&wsz!y120l8@'
...
ROOT_URLCONF = 'GestaodeFinancas.urls'
...
WSGI_APPLICATION = 'GestaodeFinancas.wsgi.application'
